...
class TestNaturalKey(TestCase):
    ...
    def complete_subject_visit(self):
        ...
        screening = mommy.make_recipe('cancer_subject.subjectscreening',
                                      report_datetime=get_utcnow())
        consent = mommy.make_recipe('cancer_subject.subjectconsent',
        ...
        self.subject_visit = mommy.make_recipe(
            ...
            appointment=Appointment.objects.get(
                subject_identifier=self.subject_identifier, visit_code='???'),
