# Generated by Django 2.1 on 2018-08-28 15:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('edc_appointment', '0015_auto_20180828_1541'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('report_type', models.CharField(choices=[('Original report of an event', 'Original report of an event'), ('Updated information', 'Updated information'), ('Resolution', 'Resolution')], max_length=35, verbose_name='Which type of report is this? ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_unscheduled', models.CharField(choices=[('Routine oncology', 'Routine oncology clinic visit (i.e. planned chemo, follow-up)'), ('Ill oncology', 'Ill oncology clinic visit'), ('Patient called', 'Patient called to come for visit'), ('OTHER', 'Other, specify:')], default='N/A', max_length=25, verbose_name="If 'Unscheduled' above, provide reason for the unscheduled visit")),
                ('reason_missed', models.CharField(blank=True, choices=[('Quarterly visit/contact', 'Quarterly visit/contact'), ('Unscheduled visit/contact', 'Unscheduled visit/contact'), ('Missed quarterly visit', 'Missed quarterly visit'), ('Lost to follow-up', 'Lost to follow-up (use only when taking subject off study)'), ('Death', 'Death'), ('off study', 'Off study'), ('deferred', 'Deferred')], max_length=35, null=True, verbose_name="If 'Missed' above, provide the reason the scheduled visit was missed")),
                ('info_source', models.CharField(choices=[('Clinic visit w/ subject', 'Clinic visit with participant'), ('Other contact w/ subject', 'Other contact with participant (i.e telephone call)'), ('Contact w/ health worker', 'Contact with health care worker'), ('Contact w/ family/design', 'Contact with family or designated person who can provide information'), ('OTHER', 'Other,specify')], max_length=25, verbose_name='What is the main source of this information?')),
                ('info_source_other', edc_base.model_fields.custom_fields.OtherCharField(blank=True, max_length=25, null=True, verbose_name='Other, specify')),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
