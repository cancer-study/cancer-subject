# Generated by Django 2.0b1 on 2017-10-25 14:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('health_rate', models.CharField(choices=[('Excellent', 'Excellent'), ('Very Good', 'Very Good'), ('Good', 'Good'), ('Fair', 'Fair'), ('Poor', 'Poor'), ('Very Poor', 'Very Poor')], max_length=15, verbose_name='1. Overall, how would you rate your health during the PAST 4 WEEKS?')),
                ('health_problems', models.CharField(choices=[('Not at all', 'Not at all'), ('Very Little', 'Very Little'), ('Somewhat', 'Somewhat'), ('Quite a lot', 'Quite a lot'), ('No physical activities', 'Could not do physical activities')], max_length=35, verbose_name='2. During the PAST 4 WEEKS, how much did physical health problems limit your usual physical activities (walking, climbing stairs)?')),
                ('difficulty_work', models.CharField(choices=[('None at all', 'None at all'), ('A little bit', 'A little bit'), ('Some', 'Some'), ('Quite a lot', 'Quite a lot'), ('No daily work', 'Could not do daily work')], max_length=35, verbose_name='3. During the PAST 4 WEEKS, how much difficulty did you have doing your daily work, both at home and away from home, because of your physical health?')),
                ('bodily_pain', models.CharField(choices=[('None', 'None'), ('Very mild', 'Very mild'), ('Moderate', 'Moderate'), ('Severe', 'Severe'), ('Very serere', 'Very serere')], max_length=15, verbose_name='4. How much bodily pain have you had during the PAST 4 WEEKS?')),
                ('probs_from_work', models.CharField(choices=[('Not at all', 'Not at all'), ('Very little', 'Very little'), ('Somewhat', 'Somewhat'), ('Quite a lot', 'Quite a lot'), ('No daily activities', 'Could not do daily activities')], max_length=35, verbose_name='8. During the past 4 weeks, how much did personal or emotional problems keep you from doing work, school or other daily activities?')),
                ('energy', models.CharField(choices=[('Very much', 'Very much'), ('Quite a lot', 'Quite a lot'), ('Some', 'Some'), ('A little', 'A little'), ('None', 'None')], max_length=15, verbose_name='5. During the PAST 4 WEEKS, how much energy did you have?')),
                ('health_probs_limit', models.CharField(choices=[('Not at all', 'Not at all'), ('Very little', 'Very little'), ('Somewhat', 'Somewhat'), ('Quite a lot', 'Quite a lot'), ('No social activities', 'Could not do social activities')], max_length=35, verbose_name='6. During the PAST 4 WEEKS, how much did your physical health or emotional problems limit your usual social activities with family or friends?')),
                ('emotional_probs', models.CharField(choices=[('Not at all', 'Not at all'), ('Slightly', 'Slightly'), ('Moderately', 'Moderately'), ('Quite a lot', 'Quite a lot'), ('Extremely', 'Extremely')], max_length=15, verbose_name='7. During the PAST 4 WEEKS, how much have you been bothered by emotional problems (such as feeling anxious, depressed or irritable)?')),
                ('perform_status', models.CharField(choices=[('0', 'Asymptomatic (Fully active, able to carry on all pre-disease activities without restriction)'), ('1', 'Symptomatic but completely ambulatory (Restricted in physically strenuous activity but ambulatory and able to carry out work of a light or sedentary nature. For example, light housework, office work)'), ('2', 'Symptomatic, &lt;50% in bed during the day (Ambulatory and capable of all self care but unable to carry out any work activities. Up and about more than 50% of waking hours)'), ('3', '50% in bed, but not bedbound (Capable of only limited self-care, confined to bed or chair 50% or more of waking hours)'), ('4', 'Bedbound (Completely disabled. Cannot carry on any self-care. Totally confined to bed or chair)'), ('5', 'Death')], max_length=205, verbose_name='9. What is the participant perfomance status, determined by study staff with questioning and observation of the participant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('hepatitis', models.CharField(choices=[('No', 'No'), ('Hepatitis B', 'Hepatitis B'), ('Hepatitis C', 'Hepatitis C'), ("Don't know", "Don't know")], max_length=15, verbose_name='Have you been told you have hepatitis B or C before?')),
                ...
                ('year_tb', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2020)], verbose_name='In what year did you last have tuberculosis (year of diagnosis)?')),
                ...
                ('age_firstsex', models.CharField(choices=[('younger than 15 years old', 'younger than 15 years old'), ('between 15 and 17 years old', 'between 15 and 17 years old'), ('older than 17 years old', 'older than 17 years old'), ("don't know", "don't know"), ('never', 'never'), ("Don't want to answer", "Don't want to answer"), ('Declined', 'Patient declined to answer')], max_length=35, verbose_name='How old were you when you first had sex?')),
                ...
                ('tradmedicine', models.CharField(choices=[('Never', 'Never'), ('Less than once a year', 'Less than once a year'), ('Between 1 and 5 times a year', 'Between 1 and 5 times a year'), ('Between 5 to 10 times a year', 'Between 5 to 10 times a year'), ('More than 10 times a year', 'More than 10 times a year'), ('Declined', 'Patient declined to answer')], max_length=35, verbose_name='How often do you use traditional medicine?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family_cancer_type', models.CharField(blank=True, choices=[("Don't know", "Don't know"), ('Cervical cancer', 'Cervical cancer'), ('Breast cancer', 'Breast cancer'), ('Esophageal cancer', 'Esophageal cancer'), ("Kaposi's sarcoma", "Kaposi's sarcoma"), ('Lymphoma', 'Lymphoma'), ('Liver cancer', 'Liver cancer'), ('Eye cancer', 'Eye cancer'), ('Other or multiple cancers, describe:', 'Other or multiple cancers, describe:')], max_length=45, verbose_name='What kind of cancer did your brother, sister, or parent have?')),
                ...
                ('previous_cancer', models.CharField(blank=True, choices=[("Don't know", "Don't know"), ('Cervical cancer', 'Cervical cancer'), ('Breast cancer', 'Breast cancer'), ('Esophageal cancer', 'Esophageal cancer'), ("Kaposi's sarcoma", "Kaposi's sarcoma"), ('Lymphoma', 'Lymphoma'), ('Leukemia', 'Leukemia'), ("Wilm's Tumor", "Wilm's Tumor"), ('Other', ' Other or multiple cancers, describe:')], max_length=45, verbose_name='What kind of cancer did you have before?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.CharField(choices=[('Black African', 'Black African'), ('Caucasian', 'Caucasian'), ('Asian', 'Asian'), ('Other', 'Other, specify:')], max_length=15, verbose_name='Race:')),
                ...
                ('ethnic_grp', models.CharField(choices=[('Tswana-Bangwato', 'Tswana-Bangwato'), ('Tswana-Bakwena', 'Tswana-Bakwena'), ('Tswana-Bangwaketsi', 'Tswana-Bangwaketsi'), ('Tswana-Bakgatla', 'Tswana-Bakgatla'), ('Tswana-Batawana', 'Tswana-Batawana'), ('Tswana-Barolong', 'Tswana-Barolong'), ('Tswana-Bamalete', 'Tswana-Bamalete'), ('Tswana-Batlokwa', 'Tswana-Batlokwa'), ('Bakalanga', 'Bakalanga'), ('Basarwa', 'Basarwa'), ('Kgalagadi', 'Kgalagadi'), ('White', 'White'), ('Asian', 'Asian'), ('Other', 'Other, specify:')], max_length=25, verbose_name='Ethnic Group:')),
                ...
                ('community', models.CharField(choices=[('Bokaa', 'Bokaa'), ('Digawana', 'Digawana'), ('Gumare', 'Gumare'), ('Gweta', 'Gweta'), ('Lentsweletau', 'Lentsweletau'), ('Lerala', 'Lerala'), ('Letlhakeng', 'Letlhakeng'), ('Mandunyane', 'Mandunyane'), ('Mmankgodi', 'Mmankgodi'), ('Mmadinare', 'Mmadinare'), ('Mmathethe', 'Mmathethe'), ('Masunga', 'Masunga'), ('Maunatlala', 'Maunatlala'), ('Mathangwane', 'Mathangwane'), ('Metsimotlhabe', 'Metsimotlhabe'), ('Molapowabojang', 'Molapowabojang'), ('Nata', 'Nata'), ('Nkange', 'Nkange'), ('Oodi', 'Oodi'), ('Otse', 'Otse'), ('Raikops', 'Raikops'), ('Ramokgonami', 'Ramokgonami'), ('Ranaka', 'Ranaka'), ('Sebina', 'Sebina'), ('Sefare', 'Sefare'), ('Sefophe', 'Sefophe'), ('Shakawe', 'Shakawe'), ('Shoshong', 'Shoshong'), ('Tati Siding', 'Tati Siding'), ('Tsetsebjwe', 'Tsetsebjwe'), ('DWTA', 'Do not want to answer'), ('Other', 'Other community')], max_length=35, verbose_name='Since 2014, what community have you lived in?')),
                ...
                ('education', models.CharField(choices=[('None', 'None'), ('Primary', 'Primary'), ('Junior secondary', 'Junior secondary'), ('Senior secondary', 'Senior secondary'), ('Tertiary', 'Tertiary')], max_length=25, verbose_name='Educational level completed:')),
                ('occupation', models.CharField(choices=[('Housewife', 'Housewife'), ('Salaried (government)', 'Salaried (government)'), ('Salaried (private)', 'Salaried (private)'), ('Domestic work (paid)', 'Domestic work (paid)'), ('Self-employed', 'Self-employed'), ('Student', 'Student'), ('Unemployed', 'Unemployed'), ('Other', 'Other, specify:')], max_length=25, verbose_name='Occupation:')),
                ...
                ('toilet', models.CharField(choices=[('Indoor toilet', 'Indoor toilet'), ('Private latrine', 'Private latrine for your house/compound'), ('Shared latrine', 'Shared latrine with other compounds'), ('No latrine', 'No latrine facilities'), ('Other', 'Other, specify:')], max_length=45, verbose_name='Which of the following types of toilet facilities do you most often use at home?')),
                ...
                ('household_people', models.IntegerField(verbose_name='How many people, including yourself, stay in your household/compound most of the time?')),
                ('food_security', models.CharField(choices=[('Never', 'Never'), ('Rarely', 'Rarely'), ('Sometimes', 'Sometimes'), ('Often', 'Often'), ('Declined', 'Patient declined to answer')], max_length=15, verbose_name='In the past 4 weeks, did you or any household member have to eat a smaller meal than you felt you needed, or even to skip a meal, because there was not enough food?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('age_period', models.IntegerField(verbose_name='At what age did you start having your menstrual period?')),
                ('children', models.IntegerField(verbose_name='How many children have you given birth to?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('fuel_20y', models.CharField(choices=[('solid fuels', 'solid fuels (dung, charcoal, wood, crops, coal)'), ('kerosene or gas', 'kerosene or gas'), ('electricity', 'electricity'), ("don't know", "don't know"), ('Other', 'Other, specify')], max_length=55, verbose_name='Over the past 20 years, what type of fuel was used most for cooking/heating in your household?')),
                ('fuel_20y_other', edc_base.model_fields.custom_fields.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If Other, specify ...')),
                ...
                ('fuel_mm', models.CharField(choices=[('solid fuels', 'solid fuels (dung, charcoal, wood, crops, coal)'), ('kerosene or gas', 'kerosene or gas'), ('electricity', 'electricity'), ("don't know", "don't know"), ('Other', 'Other, specify')], max_length=55, verbose_name='In the past month, what type of fuel was used most for cooking / heating in your household?')),
                ('fuel_mm_other', edc_base.model_fields.custom_fields.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If Other, specify ...')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('mine_time', models.CharField(choices=[('<5 years', 'less than 5 years'), ('5 to 20 years', 'between 5 and 20 years'), ('>20 years', 'more than 20 years')], max_length=25, verbose_name='43. What is the total amount of time you worked in the mine?')),
                ('mine_type', models.CharField(choices=[('gold', 'gold'), ('diamond', 'diamond'), ('copper', 'copper'), ('nickel', 'nickel'), ('other, specify:', 'other, specify:')], max_length=25, verbose_name='44. What kind of mine have you worked in?')),
                ...
                ('mine_underground', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('Dont_know', 'Do not Know')], max_length=25, verbose_name='45. Have you ever worked UNDERGROUND in a mine?')),
                ('mine_underground_time', models.CharField(blank=True, choices=[('<5 years', 'less than 5 years'), ('5 to 20 years', 'between 5 and 20 years'), ('>20 years', 'more than 20 years')], max_length=25, verbose_name='46. What is the total amount of time you worked UNDERGROUND in the mine?')),
                ('last_mine', models.DateField(max_length=25, verbose_name='47. When did you last work in a mine?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cigarette_smoking', models.CharField(blank=True, choices=[('14 or fewer cigarettes a day', '14 or fewer cigarettes a day'), ('between 15 and 25 cigarettes a day', 'between 15 and 25 cigarettes a day'), ('more than 25 cigarettes a day', 'more than 25 cigarettes a day'), ('refused', 'Participant declined to answer')], max_length=35, null=True, verbose_name='How many cigarettes do you smoke per day?')),
                ...
                ('cigarette_smoked', models.CharField(blank=True, choices=[('14 or fewer cigarettes a day', '14 or fewer cigarettes a day'), ('between 15 and 25 cigarettes a day', 'between 15 and 25 cigarettes a day'), ('more than 25 cigarettes a day', 'more than 25 cigarettes a day'), ('refused', 'Participant declined to answer')], max_length=35, null=True, verbose_name='How many cigarettes did you smoke per day?')),
                ('when_quit', models.CharField(blank=True, choices=[('less than 2 years ago', 'less than 2 years ago'), ('between 2 and 10 years ago', 'between 2 and 10 years ago'), ('between 10 and 20 years ago', 'between 10 and 20 years ago'), ('more than 20 years ago', 'more than 20 years ago'), ('refused', 'Participant declined to answer')], max_length=35, null=True, verbose_name='When did you quit smoking cigarettes?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('hours_outdoor', models.CharField(choices=[('1 hour or less', '1 hour or less'), ('2 hours', '2 hours'), ('3 hours', '3 hours'), ('4 hours', '4 hours'), ('5 hours', '5 hours'), ('6 hours', '6 hours')], max_length=15, verbose_name='On average, how many hours are you outdoors per day between 10am and 4pm?')),
                ('sleeved_shirt', models.CharField(choices=[('never', 'never'), ('rarely', 'rarely'), ('sometimes', 'sometimes'), ('often', 'often'), ('always', 'always')], max_length=15, verbose_name='When you are outside on a sunny day, how often do you wear a SHIRT WITH SLEEVES?')),
                ('hat', models.CharField(choices=[('never', 'never'), ('rarely', 'rarely'), ('sometimes', 'sometimes'), ('often', 'often'), ('always', 'always')], max_length=15, verbose_name='When you are outside on a sunny day, how often do you wear a HAT?')),
                ('shade_umbrella', models.CharField(choices=[('never', 'never'), ('rarely', 'rarely'), ('sometimes', 'sometimes'), ('often', 'often'), ('always', 'always')], max_length=15, verbose_name='When you are outside on a sunny day, how often do you stay in the SHADE or UNDER AN UMBRELLA?')),
                ('sunglasses', models.CharField(choices=[('never', 'never'), ('rarely', 'rarely'), ('sometimes', 'sometimes'), ('often', 'often'), ('always', 'always')], max_length=15, verbose_name='When you are outside on a sunny day, how often do you wear SUNGLASSES?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('nadir_cd4', models.DecimalField(decimal_places=2, help_text='If current (most recent) CD4 is lowest recorded, record again here.', max_digits=6, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3000)], verbose_name="8. What is the value of the lowest 'CD4' test recorded?")),
                ('nadir_cd4_drawn_date', models.DateField(max_length=25, null=True, verbose_name="9. Date 'CD4' test was run:")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symptom_prompt', models.CharField(blank=True, choices=[('Pain', 'Pain'), ('Lump/Mass', 'Lump/Mass'), ('Fever', 'Fever'), ('Cough', 'Cough'), ('Shortness of Breath', 'Shortness of Breath'), ('Bleeding', 'Bleeding'), ('Weight loss', 'Weight loss'), ('Swelling of leg', 'Swelling of leg'), ('Difficulty swallowing', 'Difficulty swallowing'), ('Bump/rash on skin or eye', 'Bump/rash on skin or eye'), ('Other', 'Other')], max_length=25, null=True, verbose_name='What symptom was most important in prompting patient to seek care leading to diagnosis of cancer?')),
                ...
                ('diagnosis_basis', models.CharField(blank=True, choices=[('Clinical Only', 'Clinical Only'), ('Clinical AND Radiology (CT, X-ray, U/S)', 'Clinical AND Radiology (CT, X-ray, U/S)'), ('Surgery', 'Surgery'), ('Biochemical/Immunological Test', 'Biochemical/Immunological Test'), ('Cytology/Haematology', 'Cytology/Haematology'), ('Histology of Metastasis', 'Histology of Metastasis'), ('Histology of Primary', 'Histology of Primary'), ('Autopsy with Histology', 'Autopsy with Histology'), ('Other', 'Other (including unknown): ')], max_length=45, null=True, verbose_name='Basis of diagnosis')),
                ...
                ('tumour', models.CharField(blank=True, choices=[('UNK', 'Unknown'), ('X', 'X'), ('0', '0'), ('1', '1'), ('2', '2'), ('3', '3'), ('4', '4')], help_text="For Kaposi's record T here, 0 or 1", max_length=15, null=True, verbose_name='TNM system- Tumour (T)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('drug_code', models.CharField(choices=[('AMOX = amoxicillin', 'AMOX = amoxicillin'), ('ALLO = allopurinol', 'ALLO = allopurinol'), ('BLEO = bleomycin', 'BLEO = bleomycin'), ('CARB = carboplatin', 'CARB = carboplatin'), ('CARM = carmustine', 'CARM = carmustine'), ('CAPC = capecitabine', 'CAPC = capecitabine'), ('CDX = casodex', 'CDX = casodex'), ('CIPR = ciprofloxacin', 'CIPR = ciprofloxacin'), ('CISP = cisplatin', 'CISP = cisplatin'), ('CYCL = cyclophosphamide', 'CYCL = cyclophosphamide'), ('CYTB = cytarabine', 'CYTB = cytarabine'), ('CTXM = cotrimoxazole', 'CTXM = cotrimoxazole'), ('DAUN = daunorubicin,', 'DAUN = daunorubicin,'), ('DCAR = dacarbazine', 'DCAR = dacarbazine'), ('DEXA = dexamethasone', 'DEXA = dexamethasone'), ('DOXO = doxorubicin', 'DOXO = doxorubicin'), ('DTAX = docetaxel', 'DTAX = docetaxel'), ('ETOP = etoposide', 'ETOP = etoposide'), ('FLOR = fluorouracil', 'FLOR = fluorouracil'), ('GEMC = gemcitabine', 'GEMC = gemcitabine'), ('GLEE = gleevec', 'GLEE = gleevec'), ('HERC = herception', 'HERC = herception'), ('HYDX = hydroxyurea', 'HYDX = hydroxyurea'), ('IFOS = ifosfamide', 'IFOS = ifosfamide'), ('IRIN = irinotecan', 'IRIN = irinotecan'), ('LEUK = leukovorin', 'LEUK = leukovorin'), ('LEUP = leuprolide', 'LEUP = leuprolide'), ('LDOX = liposomal doxorubicin', 'LDOX = liposomal doxorubicin'), ('MECH = mechlorethamine', 'MECH = mechlorethamine'), ('METO = metocloperamide (maxolone)', 'METO = metocloperamide (maxolone)'), ('METX = methatrexate', 'METX = methatrexate'), ('MITO = mitoxantrone', 'MITO = mitoxantrone'), ('OXAL = oxaliplatin', 'OXAL = oxaliplatin'), ('PROC = procarbazine', 'PROC = procarbazine'), ('PROM = promethazine', 'PROM = promethazine'), ('PRED = prednisone', 'PRED = prednisone'), ('PTAX = paclitaxel', 'PTAX = paclitaxel'), ('RANT = ranitidine', 'RANT = ranitidine'), ('RITX', 'RITX = Rituximab'), ('TAMX = tamoxifen', 'TAMX = tamoxifen'), ('VINC = vincristine', 'VINC = vincristine'), ('VINB = vinblastine', 'VINB = vinblastine'), ('VINO = vinorelbine', 'VINO = vinorelbine'), ('ZDX = zoladex', 'ZDX = zoladex'), ('OTHR = other', 'OTHR = other')], max_length=35, verbose_name='Drug')),
                ('dose_category', models.CharField(blank=True, choices=[('1 = Standard', '1 = Standard'), ('2 = Reduced Dose', '2 = Reduced Dose'), ('3 = Other ', '3 = Other ')], max_length=35, null=True, verbose_name='Dose category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('drug_name', models.CharField(choices=[('ATR', 'Atripla (ATR)'), ('CBV', 'Combivir (CBV)'), ('EFV', 'Efavirenz (EFV)'), ('NVP', 'Nevirapine (NVP)'), ('3TC', 'Lamivudine (3TC)'), ('FTC', 'Emtricitabine (FTC)'), ('AZT_ZDV', 'Zidovudine (AZT or ZDV)'), ('TDF', 'Tenofovir (TDF)'), ('ABC', 'Abacavir (ABC)'), ('D4T', 'Stavudine (D4T)'), ('DDI', 'Didanosine (DDI)'), ('ALU', 'Aluvia/Kaletra (ALU)'), ('DRV', 'Darunavir (DRV)'), ('RAL', 'Raltegravir (RAL)'), ('OTHER', 'Other, specify')], max_length=35, verbose_name='1.Drug Name')),
                ('mod_reason', models.CharField(blank=True, choices=[('11 = Initiation (or re-initiation after non-adherence/stockout)', '11 = Initiation (or re-initiation after non-adherence/stockout)'), ('12 = Toxicity decreased/resolved', '12 = Toxicity decreased/resolved'), ('13 = Vomiting', '13 = Vomiting'), ('14 = CNS symptoms (sleep,psych, etc)', '14 = CNS symptoms (sleep,psych, etc)'), ('15 = Diarrhea', '15 = Diarrhea'), ('16 = Hypersensitivity/allergic reaction', '16 = Hypersensitivity/allergic reaction'), ('17 = Hepatotoxicity', '17 = Hepatotoxicity'), ('18 = Neutropenia', '18 = Neutropenia'), ('19 = Anemia', '19 = Anemia'), ('20 = Renal failure20 = Renal failure', '20 = Renal failure20 = Renal failure'), ('21 = Other toxicity (specify in comments)', '21 = Other toxicity (specify in comments)'), ('22 = Virologic failure', '22 = Virologic failure'), ('23 = Immunologic failure (CD4)', '23 = Immunologic failure (CD4)'), ('24 = Clinical failure', '24 = Clinical failure'), ('25 = Non-adherence', '25 = Non-adherence'), ('26 = Interaction with cancer treatment', '26 = Interaction with cancer treatment'), ('27 = Death', '27 = Death'), ('28 = Other (specify in comments) ', '28 = Other (specify in comments) ')], max_length=65, null=True, verbose_name='2.Mod Reason')),
                ('arv_reason', models.CharField(choices=[('1 = Treatment', '1 = Treatment'), ('2 = PMTCT', '2 = PMTCT'), ('3 = PEP ', '3 = PEP ')], max_length=25, verbose_name='3.Reason for ARVs')),
                ('start_date', models.DateField(help_text='dd/mm/yyyy', max_length=25, verbose_name='4.Date Started')),
                ('stop_date', models.DateField(blank=True, help_text='dd/mm/yyyy', max_length=25, null=True, verbose_name='5.Date Stopped')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('haart_status', models.CharField(blank=True, choices=[(' Never started HAART "(skip to Question 4)"', ' Never started HAART "(skip to Question 4)"'), (' Follow-up visit, no modifications since last visit made to HAART treatment "(skip to Question 4)"', ' Follow-up visit, no modifications since last visit made to HAART treatment "(skip to Question 4)"'), (' Enrollment visit, patient has taken or is taking HAART "(go to Question 3, record all current and past HAART medications)"', ' Enrollment visit, patient has taken or is taking HAART "(go to Question 3, record all current and past HAART medications)"'), (' Change in at least one antiretroviral medication (dose modification, discontinuation, temporary hold, change of medication) "(go to Question 3)"', ' Change in at least one antiretroviral medication (dose modification, discontinuation, temporary hold, change of medication) "(go to Question 3)"')], max_length=145, null=True, verbose_name="What is the status of the participant's antiretroviral treatment (HAART)?")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('cd4_drawn_date', models.DateField(max_length=25, verbose_name='5. Date of CD4 cell count')),
                ('cd4_result', models.DecimalField(decimal_places=2, max_digits=6, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3000)], verbose_name='6. CD4 cell count result')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('test_date', models.DateField(blank=True, max_length=25, null=True, verbose_name='2. Date of HIV test')),
                ('test_result', models.CharField(choices=[('POS', 'Reactive'), ('NEG', 'Non-Reactive')], max_length=15, verbose_name='3. HIV test result')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tb_treatment', models.CharField(choices=[('No', 'No'), ('Yes, isoniazid preventative therapy (IPT)', 'Yes, isoniazid preventative therapy (IPT)'), ('Yes, combination anti-tuberculosis treatment (ATT)', 'Yes, combination anti-tuberculosis treatment (ATT)')], max_length=50, verbose_name='Is participant being treated for tuberculosis now?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chemo_intent', models.CharField(blank=True, choices=[('Standard', 'Standard'), (' Adjuvant', ' Adjuvant'), (' Neo-Adjuvant', ' Neo-Adjuvant'), ('concurrent_with_radiation', 'Concurrent with radiation')], max_length=25, null=True, verbose_name='What was the intent of giving chemotherapy?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('chemo_intent', models.CharField(choices=[('Standard', 'Standard'), (' Adjuvant', ' Adjuvant'), (' Neo-Adjuvant', ' Neo-Adjuvant'), ('concurrent_with_radiation', 'Concurrent with radiation')], max_length=25, verbose_name='What was the intent of giving chemotherapy?')),
                ...
                ('why_delayed', models.CharField(blank=True, choices=[('HemeTox', 'Toxicity - hematologic (anemia, neutropenia, or thromobcytopenia)'), ('HepatoTox', 'Toxicity - hepatitis (jaundice, increased bilirubin, ALT/AST, etc.) '), ('RenalTox', 'Toxicity - renal failure (increased creatinine, swelling, etc)'), ('OtherTox', 'Toxicity - other, specify '), ('No Response', 'Cancer not responding to treatment'), ('Default', 'Defaulted visit or lost-to-follow-up'), ('Outage', 'Outage of medication, supplies, laboratory results'), ('Clinic busy', 'Clinic too busy to accommodate'), ('Other, specify ', 'Other, specify ')], max_length=65, verbose_name='Why were the chemotherapy doses/cycles delayed?')),
                ...
                ('why_reduced', models.CharField(blank=True, choices=[('HemeTox', 'Toxicity - hematologic (anemia, neutropenia, or thromobcytopenia)'), ('HepatoTox', 'Toxicity - hepatitis (jaundice, increased bilirubin, ALT/AST, etc.)'), ('RenalTox', 'Toxicity - renal failure (increased creatinine, swelling, etc)'), ('OtherTox', 'Toxicity - other, specify '), ('No Response', 'Cancer not responding to treatment'), ('Default', 'Defaulted visit or lost-to-follow-up'), ('Outage', 'Outage of medication, supplies, laboratory results'), ('Clinic busy', 'Clinic too busy to accommodate'), ('Standard protocol', 'Dose reduced due to standard protocol (i.e. reduced intensity CHOP)'), ('Other, specify ', 'Other, specify ')], max_length=75, verbose_name='Why were the chemotherapy doses (or number of cycles) reduced?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treatment_relationship', models.CharField(blank=True, choices=[('UNK', 'Unknown'), ('no modalities', 'No other treatment modalities'), ('concurrent chemo', 'Concurrent chemotherapy'), ('Adj after surgery', 'Adjuvant after surgery'), ('Adj after chemo', 'Adjuvant after chemotherapy'), ('Adj after surgery and chemo', 'Adjuvant after surgery and chemotherapy'), ('Neo before chemo', 'Neoadjuvant before Chemotherapy'), ('Neo before surgery', 'Neoadjuvant before Surgery'), ('Other', 'Other, specify')], max_length=55, null=True, verbose_name='Relationship to other treatment modalities')),
                ...
                ('response', models.CharField(blank=True, choices=[('UNK', 'Unknown'), ('Complete', 'Complete'), ('Almost Complete', 'Almost Complete'), ('Residual Tumor', 'Residual Tumor'), ('Poor response', 'Poor response'), ('Good palliation', 'Good palliation'), ('Modest Palliation', 'Modest Palliation'), ('Poor Palliation', 'Poor Palliation'), ('Other', 'Other, specify')], max_length=55, null=True, verbose_name='Response to Treatment')),
                ...
                ('if_doses_missed', models.CharField(blank=True, choices=[('Toxicity hematologic', 'Toxicity- hematologic (anemia, neutropenia, or low plts), '), ('Toxicity skin', 'Toxicity-skin (dermatitis, mucositis), '), ('unresponsive', 'Cancer not responding to treatment'), ('defaulted', 'Defaulted visit or lost to follow-up'), ('machine downtime', 'Machine down-time or repair'), ('no accomodation', 'clinic too busy to accommodate'), ('no transport', 'lack of transportation to facility'), ('Other', 'Other, specify')], max_length=85, null=True, verbose_name='If yes, why were treatments missed? ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('radiation_technique', models.CharField(blank=True, choices=[('AP/PA', 'AP/PA'), ('4-field Box', '4-field Box'), ('Opposed Laterals', 'Opposed Laterals'), ('Tangents', 'Tangents'), ('IMRT', 'IMRT'), ('IR 192', 'IR 192'), ('Other', 'Other Technique')], max_length=25, null=True, verbose_name='Radiation Technique')),
                ...
                ('modality', models.CharField(blank=True, choices=[('Photons', 'Photons'), ('Electrons', 'Electrons'), ('Brachy', 'Brachy'), ('Particle Therapy', 'Particle Therapy'), ('Other Energy', 'Other Energy')], max_length=25, verbose_name='Modality')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referrals', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text="( if 'No' , STOP and return form to DMC. )", max_length=3, verbose_name='1. Have any referrals been made that should be reported been made (by study team or hospital staff)?')),
                ('why_referred', models.CharField(choices=[(' IDCC (infectious disease) for HAART initiation', ' IDCC (infectious disease) for HAART initiation'), (' IDCC (infectious disease) for modification of HAART (failure, toxicity, etc)', ' IDCC (infectious disease) for modification of HAART (failure, toxicity, etc)'), (' GOPD, TB clinic, or local clinic for evaluation/treatment of TB', ' GOPD, TB clinic, or local clinic for evaluation/treatment of TB'), (' Psychiatry for treatment of depression or other mental illness', ' Psychiatry for treatment of depression or other mental illness'), (' Social work for assistance with food basket, home services, or other needs', ' Social work for assistance with food basket, home services, or other needs'), (' Other, explain:', ' Other, explain:')], max_length=75, verbose_name='2. Where and why has patient been referred?')),
                ('referral_date', models.DateTimeField(help_text='dd/mm/yyyy', max_length=25, verbose_name='3. Date of referral?')),
                ('comments', models.CharField(max_length=35, verbose_name='4. Comments')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symptom_date', models.DateField(blank=True, max_length=25, null=True, verbose_name='When did you first notice the symptom that led to a diagnosis of cancer?')),
                ('medical_doctor_date', models.DateField(blank=True, max_length=25, null=True, verbose_name='When did you first see a medical doctor for the symptom?')),
                ('trad_doctor_date', models.DateField(blank=True, max_length=25, null=True, verbose_name='When did you first see a traditional doctor for the symptom?')),
                ...
                ('neg_date', models.DateField(blank=True, help_text="if 'within the last 6 months' END form ", max_length=25, null=True, verbose_name='When was your last negative HIV test?')),
                ('hiv_result', models.CharField(choices=[('Pos', 'Positive (both rapid tests)'), ('Neg', 'Negative (both rapid tests)'), ('Ind', 'Indeterminate (different results on rapid tests)'), ('Pending', 'Result pending (sent to lab waiting for result)'), ('Refusing', 'Patient refuses HIV testing today')], help_text='Provide appropriate post-test counselling and referral to care. If indeterminate, send patient to the lab for re-testing and ELISA', max_length=18, verbose_name='HIV test result')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model_validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Report Date')),
                ('tx_response_class', models.CharField(choices=[('Progressive disease (tumors are growing or new tumors are appearing)', 'Progressive disease (tumors are growing or new tumors are appearing)'), ('Stable disease (no substantial change in size or location of tumors)', 'Stable disease (no substantial change in size or location of tumors)'), ('Partial response (at least 50% decrease in tumor size, but less than 100% decrease)', 'Partial response (at least 50% decrease in tumor size, but less than 100% decrease)'), ('Complete response (all detectable cancer is gone, 100% decrease)', 'Complete response (all detectable cancer is gone, 100% decrease)'), ('Too early after treatment to assess treatment response', 'Too early after treatment to assess treatment response'), ('Cannot determine due to pending/missing/unavailable studies (labs, radiology, exam, etc.)', 'Cannot determine due to pending/missing/unavailable studies (labs, radiology, exam, etc.)'), ('Not recorded', 'Not recorded')], max_length=95, verbose_name='1. Response to cancer treatment as classified by oncologist / doctor?')),
                ('tx_response_date', models.DateField(max_length=25, verbose_name='3. Date of assessment of treatment response:')),
                ('tx_response', models.TextField(max_length=350, verbose_name='4. Briefly describe response to treatment and information used to judge treatment response: ')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='cancer_subject.SubjectVisit')),
                ('tx_info_determinant', models.ManyToManyField(max_length=45, to='cancer_subject.InfoDeterminant', verbose_name='2. Information used by oncologist / doctor to determine treatment response?')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='subjectvisit',
            unique_together={('subject_identifier', 'visit_schedule_name', 'schedule_name', 'visit_code'), ('subject_identifier', 'visit_schedule_name', 'schedule_name', 'report_datetime')},
        ),
    ]
